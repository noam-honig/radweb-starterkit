...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(auth, context) {
        var _this = this;
        this.auth = auth;
        this.context = context;
        this.confirmPassword = new radweb_1.StringColumn({ caption: 'Confirm Password', inputType: 'password' });
        this.helpers = this.context.for(users_1.Users).gridSettings({
            ...
            onValidate: function (h) {
                if (h)
                    if (h.password.value != _this.confirmPassword.value) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        userInfo = this.helpers.currentRow;
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [auth_service_1.AuthService, context_1.Context])
    ], RegisterComponent);
